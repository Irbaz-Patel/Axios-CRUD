...
function App() {
  ...
  return (
    <>
      <div className="sm:container mx-auto bg-neutral-700 py-8 min-h-screen text-gray-200">
        {/* Input section */}
        <Form
          data={data}
          setData={setData}
          ...
          <div className="flex flex-wrap justify-center gap-5">
            {data.map((item, id) => {
              return (
                <div
                  key={id}
                  className="w-80 min-h-[200px] p-4 bg-white border-l-[7px] border-black rounded-sm"
                >
