...
const Form = ({
  ...
  return (
    <>
      <form
        onSubmit={editData ? handleUpdatePost : handleCreatePost}
        className="max-w-sm media375:w-[17rem] media320:w-[15rem] media320:flex-col flex sm:flex-row media375:flex-col media424px:flex-col justify-center sm:space-x-3 mx-auto"
      >
        {/* <input
            type="text"
            name='title'
        ...
        <input
          ...
          value={addData.title}
          onChange={handleChange}
          className="py-3 px-5 flex-1 border-gray-300 rounded-full text-sm focus:border-blue-500 focus:ring-blue-500 bg-black text-white placeholder-gray-500"
          placeholder="Title Text..."
        />
        <input
          type="text"
          ...
          value={addData.body}
          onChange={handleChange}
          className="py-3 px-5 sm:mt-0 media320:mt-2 media375:mt-2 media424px:mt-2 flex-1 border-gray-300 rounded-full text-sm focus:border-blue-500 focus:ring-blue-500 bg-black text-white placeholder-gray-500"
          placeholder="Body Text..."
        />
        ...
        <button
          type="submit"
          className="py-3 sm:mt-0 media320:mt-2  media375:mt-2 media424px:mt-3 px-5 bg-blue-700 text-white rounded-full text-sm font-medium hover:bg-blue-900 focus:outline-none focus:bg-blue-700"
        >
          {editData ? "Update" : "Add"}
        </button>
      </form>
